export const personalInfo = {
  ...
  about: [
  "I'm a Software Developer from Solapur, India, passionate about building scalable applications and solving real-world problems through technology. My journey began with a Diploma in Information Technology and continued through a B.Tech in Computer Science and Engineering.",
  "I've built projects ranging from real-time Android chat applications and healthcare systems to AI-powered full-stack platforms using Java, React, Node.js, MongoDB, Firebase, and Gemini AI.",
  "I enjoy working across the full stack, with a strong focus on backend development, system design, and creating clean, maintainable, and efficient software solutions.",
  "Currently, I'm seeking opportunities to contribute, learn, and grow while building impactful products that solve meaningful problems.",
],
...
export const chatbotResponses = [
  ...
  { keywords: ["resume", "cv", "download", "pdf"], answer: "You have two ways to get my resume: either download it directly from the top Hero section, or grab it from my Drive link: https://drive.google.com/file/d/1uh1i0jJzYuCpWWXz3RTcR1LLXpvbzXKX/view" },
